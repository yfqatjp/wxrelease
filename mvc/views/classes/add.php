                ...
                <form class="form-horizontal" role="form" method="post">
                    ...
                    <label class="col-sm-2 control-label"><?=$this->lang->line("classes_category")?></label>
                        ...
                        <?php
                            ...
                            if (isset($classes)){
                                ...
                                echo form_dropdown("category", $studentCategory, set_value("category",$category), "id='category' class='form-control'");
                            }
                        ?>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-warning" value="<?=$this->lang->line("add_class")?>" >
                        </div>
                    </div>
