            ...
            <div class="col-sm-8">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                              ...
                              echo form_dropdown("codename", $codename, set_value("codename",$code->codeName), "id='codename' class='form-control'");
                            ?>
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="codevalue" name="codevalue" value="<?=set_value('codevalue', $code->codeValue)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
