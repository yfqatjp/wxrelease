	...
	<section class="content invoice" >
		...
		<div class="row">
		    <div class="col-xs-12">
		        <h2 class="page-header">
		            ...
		            <small class="pull-right"><?=$this->lang->line('invoice_create_date').' : '.date('Y/m/d')?></small>
		        </h2>
		    </div><!-- /.col -->
		</div>
		<!-- info row -->
		<div class="row invoice-info">
		    ...
		    <div class="col-sm-4 invoice-col">
		        ...
		        <?php
                    if($invoice->paiddate) {
                        echo "<b>".$this->lang->line("invoice_pdate")." :  </b>". date("Y/m/d", strtotime($invoice->paiddate)).'<br/>';
                    }
                ?>
                <?php 
