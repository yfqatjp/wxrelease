...
<html>
    <head>
        ...
        <script type="text/javascript" src="<?php echo base_url('assets/minicolors/jquery.minicolors.min.js'); ?>"></script>
        ...
        <link href="<?php echo base_url('assets/timepicker/timepicker.css'); ?>" rel="stylesheet">
         <link href="<?php echo base_url('assets/minicolors/jquery.minicolors.css'); ?>" rel="stylesheet">       
        ...
        <link href="<?php echo base_url('assets/inilabs/rid.css'); ?>" rel="stylesheet">
